        ...
        <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
            ...
            <TabsContent value="overview" className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <Card className={`border-none shadow-sm hover:shadow-lg transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] bg-white dark:bg-[#1c1917] border-l-4 border-l-[#99775C] hover:-translate-y-2 hover:scale-[1.02] active:scale-[0.98] cursor-pointer ${startAnimation ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{ transitionDelay: "100ms" }} >
                    ...
                    <Card className={`border-none shadow-sm hover:shadow-lg transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] bg-white dark:bg-[#1c1917] border-l-4 border-l-orange-500 hover:-translate-y-2 hover:scale-[1.02] active:scale-[0.98] cursor-pointer ${startAnimation ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{ transitionDelay: "200ms" }} >
                    ...
                    <Card className={`border-none shadow-sm hover:shadow-lg transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] bg-white dark:bg-[#1c1917] border-l-4 border-l-blue-500 hover:-translate-y-2 hover:scale-[1.02] active:scale-[0.98] cursor-pointer ${startAnimation ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{ transitionDelay: "300ms" }} >
