  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full bg-[#450a0a] dark:bg-[#2a0505] border-r border-[#5c0e0e] dark:border-[#3d0808] text-white">
        ...
        <div className="flex-1 overflow-y-auto py-6 px-4 flex flex-col gap-2">
            ...
            {/* Active State: Izin */}
            <Link href="/izin" className="flex items-center gap-3 px-4 py-3 bg-white/10 text-white rounded-xl font-bold transition-all shadow-lg border border-white/10 backdrop-blur-sm">
    ...
    <div className="min-h-screen bg-[#F2F5F8] dark:bg-slate-950 font-sans transition-colors duration-300">
      ...
      >
          <div className="flex items-center gap-4">
             ...
             <h1 className="font-bold text-xl text-slate-800 dark:text-slate-100">Pengajuan Izin</h1>
          </div>
                ...
                <Card className="border-none shadow-md bg-white dark:bg-slate-900 w-full">
                    <CardHeader className="pb-4 border-b border-slate-100 dark:border-slate-800">
                        <CardTitle className="flex items-center gap-2 text-lg">
                            {/* Icon Kotak Merah */}
                            <div className="p-2 bg-[#450a0a]/10 rounded-lg text-[#450a0a] dark:text-red-400">
                    ...
                    <CardContent className="pt-6">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <Button 
                                type="submit" 
                                className="w-full bg-[#450a0a] hover:bg-[#5c0e0e] text-white h-12 text-base font-semibold rounded-xl shadow-lg shadow-red-900/10"
                        ...
                        requests.map((req) => (
                            <Card key={req.id} className="shadow-sm border-slate-100 dark:border-slate-800 hover:shadow-md transition-all bg-white dark:bg-slate-900">
                                <CardContent className="p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                    ...
                                    <div className="flex items-center gap-4">
                                        {/* Icon Tanggal Merah */}
                                        <div className="h-14 w-14 rounded-2xl bg-[#450a0a]/5 text-[#450a0a] dark:bg-red-900/20 dark:text-red-400 flex flex-col items-center justify-center font-bold border border-[#450a0a]/10 shrink-0">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-slate-800 dark:text-slate-100 text-lg hover:text-[#450a0a] transition-colors capitalize">
